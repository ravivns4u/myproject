...
import type { ReqPayload } from '../../../redux/interfaces/backend/apis/ImagePortfolio';

import { updateImagePortfolio } from '../../../firebase/db/portfolios/portfolioUpdate';
import {
  errorResponse as eR,
...
const countHandler: NextApiHandler = async (request, response) => {
  ...
  const updateResponse = await updateImagePortfolio(payload, modification);
  if (!updateResponse) {
