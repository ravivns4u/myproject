                                ...
                                >
                                    ...
                                    >
                                        <Card>
                                            ...
                                            >
                                                <Typography variant={'h2'} gutterBottom sx={{ display:{xs:'none',md:'block'}, textAlign: 'center', fontWeight: 'bold' }}>
                                                    {eventsData.name}
                                                </Typography>
                                              <Typography variant={'h4'} gutterBottom sx={{display:{xs:'block',md:'none'}, textAlign: 'center', fontWeight: 'bold' }}>
                                                {eventsData.name}
                                              </Typography>
                                                {/*<Box
                                                    sx={{
